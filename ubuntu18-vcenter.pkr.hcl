#----------------------------------------------------------------------------------
# Packer template to build an Ubuntu Server 18.04 LTS image on VMware vCenter
...
build {
  ...
  provisioner "shell" {
    scripts = [
      ...
      ##
      ## Uncomment the following 3 lines to enable GNOME (GUI) and install MS Code and VNC server.      
      ##
